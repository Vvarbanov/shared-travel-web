...
export const USERS_ME_CONTROLLER_URL = '/me';
export const CHANGE_PASSWORD_CONTROLLER_URL = `${ USERS_ME_CONTROLLER_URL }/password`;
...
export const REGISTER_AS_DRIVER_REQUEST_URL = `${ BACKEND_URL }${ USERS_BASE_URL }${ USERS_ME_CONTROLLER_URL }/driver`;
